...
class WeiboSpider(RedisSpider):
    ...
    def parse_login(self,response):
        ...
        return [scrapy.FormRequest('https://passport.weibo.cn/sso/login',
                                  ...
                                  formdata={
                                      'username': 'wutaomicoo@sina.cn',
                                      'password': 'YangMi120852101',
                                      'savestate': '1',
                                      'r': 'http://m.weibo.cn',
    ...
    def after_login(self,response):
        ...
        print(Cookie)
        yield scrapy.FormRequest('http://weibo.cn/yangmiblog?f=search_0',meta = {'cookiejar':response.meta['cookiejar']},
                            headers = self.head,
    ...
    def parse_page(self, response):
        html = response.body
        s = response.url
        a = response.xpath('//span[@class="ctt"]')
        print(a)
        print(s)
        print (html)
